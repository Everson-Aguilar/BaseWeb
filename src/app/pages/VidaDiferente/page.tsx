  ...
  return (
    <div>
      <section className=" relative z-0  w-screen  h-screen flex-row  md:flex justify-start items-start text-center">
        ...
        <div className=" relative   md:top-1/2 w-full md:w-1/2 text-trend  p-5 ">
      ...
      <section className=" h-screen w-screen bg-colorBase flex-row  md:flex   justify-start items-start text-start mt-10">
