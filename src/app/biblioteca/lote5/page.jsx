...
const globalDescription = "''El interior de una casa junto al diseño de iluminacion, puede hacer un buen ambiente y misterioso.''";
...
const Pack = () => {
  ...
  const basePath = "/DiseñoWeb/portfolio/g5/";
