    ...
    <section className=" relative p-5 h-screen ">
      ...
      <section className=" gap-5  md:flex flex-row  w-full h-fill space-y-5  ">
        <div className=" p-3  md:w-1/2 w-full bg-colorBase rounded-3xl  ">
          ...
          <div className=" p-5"><Platfom_registration/></div>
        </div>
        <div className=" overflow-scroll p-3 md:w-1/2 w-full bg-colorBase  text-title  rounded-3xl">
          <div className=" bg-neutral-200 p-2 rounded-2xl w-1/3 justify-center text-center">
      ...
      <section className=" p-2 bg-neutral-200 md:w-1/2 w-full mt-5  rounded-3xl flex justify-between  ">
        ...
        <div className="w-4/6"><Projects_of_interest/></div>
      </section>
