...
const RenderLinks: React.FC<LinksProps> = ({ links }) => (
  <div >
    <h3 className="font-VT323 text-3xl  text-colorBase shadow-inner-md">Links</h3>
    <div className="w-full border-b-2 border-colorBase mb-4"></div>
    <div className="h-[380px] overflow-scroll">
      {links.map((item) => (
        <div key={item.id} className="border-2 shadow-lg p-2 my-2">
          ...
          <div className="mt-2 p-2 bg-gray-200 text-colorBase">Estado: {item.status}</div>
        </div>
      ))}
    </div>
  </div>
...
const RenderEnvios: React.FC<EnviosProps> = ({ envios }) => (
  <div  >
    <h3 className="font-VT323 text-3xl mt-5 text-colorBase shadow-inner-md">Envíos</h3>
    <div className="w-full border-b-2 border-colorBase mb-4"></div>
    <div className="h-[380px] overflow-scroll">
      {envios.map((item) => (
        <div key={item.id} className="border-2 shadow-lg p-2 my-2">
