    ...
    <div className=" w-full  flex flex-col md:flex-row bg-base p-5 ">
      ...
      <div className=" h-[1000px]  bg-gradient-to-b from-white to-blue-200  w-full  p-5 bg-base">
        ...
        <div className="  relative flex justify-center items-center  bg-slate-300 bg-opacity-30 backdrop-blur-md p-4 rounded-md h-2/3 shadow-lg z-10">
          ...
          <div className="absolute h-auto w-auto   top-10 flex justify-center items-center xl:p-5 md:p-2 md:gap-2 p-2 gap-2 ">
          ...
          <div className="absolute h-auto w-auto   bottom-10 flex justify-center items-center xl:p-5 md:p-2 md:gap-2 p-2 gap-2 ">
            <div className=" xl:h-28 xl:w-28 lg:h-20 lg:w-20 md:h-14 md:w-14 h-16 w-16 panel"></div>
            <div className=" xl:h-28 xl:w-28 lg:h-20 lg:w-20 md:h-14 md:w-14 h-16 w-16 panel"></div>
            <div className=" xl:h-28 xl:w-28 lg:h-20 lg:w-20 md:h-14 md:w-14 h-16 w-16 panel"></div>
            <div className=" xl:h-28 xl:w-28 lg:h-20 lg:w-20 md:h-14 md:w-14 h-16 w-16 panel"></div>
