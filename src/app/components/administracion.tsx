...
const Login: React.FC = () => {
  ...
  return (
    <div className='relative p-1  flex  overflow-scroll justify-end text-sm font-Quicksand text-neutral-300 items-start h-full  bg-neutral-600 border-b border-neutral-400'>
      <form className='  sesion_mobil  flex-row  items-center justify-center mr-28' onSubmit={handleSubmit}>
          ...
          <label className=' mr-7  mb-1 '  htmlFor="username">Usuario:</label>
          <input className=' border h-5  mb-1 w-40 rounded-lg p-1  mr-5'
            id="username" 
            type="text"
            value={username}
        ...
        <div > 
          ...
          <label className='  mr-1 mb-1 ' htmlFor="password">Contraseña:</label>
          <input  className='  border  mb-1  h-5  w-40 rounded-lg p-1  mr-5'
            id="password"
            type="password"
            value={password}
        ...
        <div>  <button className='sesion'   type="submit">Iniciar sesión</button> </div>
